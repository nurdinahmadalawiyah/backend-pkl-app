...
class PengajuanPKLController extends Controller
{
    ...
    public function setujuiPengajuan($id)
    {
        ...
        $data_surat = DB::table('mahasiswa')
            ...
            ->join('prodi', 'mahasiswa.prodi', '=', 'prodi.id_prodi')
            ->select('mahasiswa.nama', 'mahasiswa.nim', 'prodi.nama_prodi', 'mahasiswa.tahun_masuk', 'prodi.nama_ketua_prodi', 'prodi.nidn_ketua_prodi', 'mahasiswa.notification_id')
            ->where('pengajuan_pkl.id_pengajuan', '=', $id)
            ->first();
        ...
        $filename = 'surat_pengantar_pkl_' . $data_surat->nim .  $pengajuan_pkl->id_pengajuan . '.pdf';
